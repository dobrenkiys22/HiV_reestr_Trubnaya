...
SYSTEM_PROMPT = (
    ...
    "'Грузоотправитель'), дату поставки/отгрузки, итоговую сумму С НДС (поле 'Стоимость "
    "товаров с налогом — всего' / 'Итого к оплате с НДС'). Если документ на несколько страниц "
    "— используй итоговую сумму с последней страницы, а не промежуточный итог. "
